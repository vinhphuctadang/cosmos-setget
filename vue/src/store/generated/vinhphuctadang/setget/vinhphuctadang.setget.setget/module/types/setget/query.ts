...
const baseQueryGetRequest: object = {};

export const QueryGetRequest = {
  encode(_: QueryGetRequest, writer: Writer = Writer.create()): Writer {
    return writer;
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseQueryGetRequest } as QueryGetRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
...
const baseQueryGetResponse: object = { value: "" };

export const QueryGetResponse = {
  encode(message: QueryGetResponse, writer: Writer = Writer.create()): Writer {
    if (message.value !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGetResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseQueryGetResponse } as QueryGetResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request(
      "vinhphuctadang.setget.setget.Query",
      "Params",
      data
    );
